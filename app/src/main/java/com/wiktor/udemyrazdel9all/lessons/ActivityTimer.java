...
public class ActivityTimer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CountDownTimer timer = new CountDownTimer(6000, 1000) { // принимает 1 - значение в миллисекундах(продолжительность) . 2 - через какой промежуток он будет тикать(интервал)
            @Override
